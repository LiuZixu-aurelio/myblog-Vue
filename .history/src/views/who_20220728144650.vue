...
export default {
  ...
  mounted(){
    ...
    document.getElementsByTagName('canvas')[0].attributes.style.nodeValue = "display: inline-block; width: 200px; height: 200px; position:absolute; top: 200px; left:600px;"
  },
  methods: {
    chufa() {
