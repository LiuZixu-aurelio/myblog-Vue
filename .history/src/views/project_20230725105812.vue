...
<script>
    ...
    export default {
        ...
        data:()=>{
            return{
                scard1,scard2,scard4,
                extest1,extest2,extest4,
                scardInfor1,scardInfor2,scardInfor4,
                pPlant1,pPlant2,pPlant4,
                pConfig1,pConfig2,pConfig4,
                data1,data2,data4,
                pChristie1, pChristie2, pChristie4,
                pOther1, pOther2, pOther4
                }
        },
        components: {
            CardCom
