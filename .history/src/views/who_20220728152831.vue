...
export default {
  ...
  mounted(){
    ...
    document.getElementsByTagName('canvas')[0].attributes.style.nodeValue = "display: inline-block; width: 300px; height: 150px; position:absolute; top: 200px; left:600px;"
  },
  methods: {
    chufa() {
