...
export default {
  ...
  mounted(){
    ...
    document.getElementsByTagName('canvas')[0].attributes.style.nodeValue = "display: inline-block; width: 400px; height: 200px; position:absolute; top: 100px; left:500px;"
  },
  methods: {
    chufa() {
