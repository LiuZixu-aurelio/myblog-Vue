...
<div id="who">
  ...
  <div id="character">
    <div>
      <div id="a1" class="transition hover:-translate-y-3 hover:skew-y-6"></div>
      <p>深度</p>
    </div>
    <div>
      <div id="b1" class="transition hover:-translate-y-3 hover:skew-y-6"></div>
      <p>创新</p>
    </div>
    <div>
      <div id="c1" class="transition hover:-translate-y-3 hover:-skew-y-6"></div>
      <p>效率</p>
    </div>
  </div>
  <div class="project">
    ...
    <div>
      <router-link :to='"/home/project/data"'>
        <div id="a5"></div>
      </router-link>
    </div>
  </div>
