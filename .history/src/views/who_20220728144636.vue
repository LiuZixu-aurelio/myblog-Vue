...
export default {
  ...
  mounted(){
    ...
    document.getElementsByTagName('canvas')[0].attributes.style.nodeValue = "display: inline-block; width: 200px; height: 100px; position:absolute; top: 400px; left:600px;"
  },
  methods: {
    chufa() {
