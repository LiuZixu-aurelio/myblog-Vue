...
<div id="who">
  ...
  <div class="project">
    <div>
      <a href="https://www.figma.com/@liuzixu" target="_blank" class="transition transform hover:scale-90">
        <div id="a2"></div>
      </a>
      <router-link :to='"/home/project/ZHIHU"' class="transition transform hover:scale-90">
        <div id="b2"></div>
      </router-link>
    </div>
    <div>
      <router-link :to='"/home/project/plantlight"' class="transition transform hover:scale-90">
        <div id="a3"></div>
      </router-link>
      <div id="b3" class="transition transform hover:scale-90"></div>
    </div>
    <div>
      <router-link :to='"/home/project/test"' class="transition transform hover:scale-90">
        <div id="a4"></div>
      </router-link>
      <div id="b4" class="transition transform hover:scale-90"></div>
    </div>
    <div>
      <router-link :to='"/home/project/data"' class="transition transform hover:scale-90">
        <div id="a5"></div>
      </router-link>
    </div>
  </div>
