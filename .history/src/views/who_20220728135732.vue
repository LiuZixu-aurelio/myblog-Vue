<template>
  <div class="whoheigt color3" id="pre1">
    <div class="whocont">
      <div class="whodiv">
        <h2>Hello，我是刘子煦</h2>
        <div class="text">
...
function animate() {
  ...
  scene.children[0].scale.x = 0.1
  scene.children[0].scale.y = 0.1
  scene.children[0].scale.z = 0.1
...
export default {
  ...
  components: {},
  mounted(){
  console.log(document.getElementById('pre1'))
