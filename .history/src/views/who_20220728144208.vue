...
export default {
  ...
  mounted(){
    ...
    document.getElementsByTagName('canvas')[0].attributes.style.nodeValue = "display: inline-block; width: 200px; height: 100px; position:absolute; top: 200px; left:700px;"
  },
  methods: {
    chufa() {
