...
export default {
  ...
  mounted(){
    ...
    document.getElementsByTagName('canvas')[0].attributes.style.nodeValue = "display: inline-block; width: 300px; height: 150px; position:absolute; top: 150px; left:600px;"
  },
  methods: {
    chufa() {
