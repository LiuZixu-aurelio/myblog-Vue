...
const aa = asset("/src/assets/sign/sign-sap.png")
const ab = 'url(' + aa +')'
...
const signSAP3 =[
    ...
    asset('/src/assets/sign/sign-sap3.png'),
    asset('/src/assets/sign/sign-sap4.png'),
    asset('/src/assets/sign/sign-sap5.png'),
    asset('/src/assets/sign/sign-sap6.png')
]
